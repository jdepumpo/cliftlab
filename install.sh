...
echo -e "Remember to commit and push the new host's age public key to .sops.yaml and re-encrypt secrets/secrets.yaml before installing!"
echo -e "To install NixOS, run the following command:\n"
echo -e "\033[1msudo nixos-install --no-root-passwd --root /mnt --flake github:jdepumpo/cliftlab#think1clift\033[0m\n"
